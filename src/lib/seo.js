...
export const SITES = [
  ...
  },
  {
    ...
    name: 'Paimon Office',
    category: 'Ongoing',
    tagline: 'Office suite tools, in development',
    description:
      'Office-focused utilities for the paimon family. Under active development - details coming soon.',
    url: 'https://github.com/paimonchan/paimon-office',
    repo: 'https://github.com/paimonchan/paimon-office',
    status: 'ongoing',
    keywords: ['office', 'excel', 'spreadsheet', 'docs', 'xlsx', 'sheet', 'tools'],
    features: ['Office tools', 'In-browser'],
    slug: 'paimon-office',
  },
  {
    id: 'paimon-translate',
